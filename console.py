...
class HBNBCommand(cmd.Cmd):
    ...
    def precmd(self, line):
        """ Changes command line for an advanced command syntax.
        ...
        try:  # parse line left to right
            ...
            if pline:
                ...
                pline = pline.partition(', ')  # pline convert to a tuple

                # isolates _id, stripping quotes
                _id = pline[0].replace('\"', '')
